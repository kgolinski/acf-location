...
class acf_field_location extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-location'),
		);
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-location', "{$dir}js/input.js" );
		wp_enqueue_script('acf-input-location');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-location'),
		}
